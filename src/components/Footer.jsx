...
const Footer = () => {
    ...
    return (
        <div className='lg:pt-[87px] md:pt-[50px] relative'>
            ...
            <div className='container mx-auto xl:max-w-[1164px] xl:px-3 px-[24px]'>
                <div className=' flex justify-center items-center flex-col'>
                    ...
                    <p className='text-[#FDFCFC] max-w-[645px] text-[14px] sm:text-[16px] font-normal leading-[20px] sm:leading-[24px] text-center my-[10px] sm:my-[16px]'>Join us on the journey to embrace the future. Experience the transformational impact of AI and automation with Noble mind</p>
                    <ul
