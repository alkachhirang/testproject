            ...
            <div id='about' className='container mx-auto xl:max-w-[1164px] xl:px-3 px-[24px]'>
                <div className='flex xl:flex-row flex-col-reverse flex-wrap items-center justify-center'>
                    ...
                    <div className='xl:w-[48%] w-full lg:ml-[20px]' data-aos="fade-left">
                        <h3 className='font-bold text-[42px] sm:text-[45px] md:text-[48px] text-[#FDFCFC] leading-[62.2px] mb-[8px] lg:mb-[2px] xl:text-start text-center'>Our <span className='bg-gradient-to-br from-[#77B000] to-[#00D863] bg-clip-text text-transparent inline-block'>Mission</span></h3>
